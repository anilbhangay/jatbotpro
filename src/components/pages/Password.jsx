      ...
      <div className='container'>
        ...
        <div className='container-input'>
            <input
              ...
              placeholder='Email'
            /><br/>
          {errors.Email && <span className='error-name-pass' >{errors.Email}</span>}<br/>
          </div>
          <div className='container-input'>
            <input
            ...
            {errors.Password && <span className='error-name-pass' id='error-name'>{errors.Password}</span>}<br/>
          </div>
          <div className='container-input'>
            <input
            ...
            {errors.Reenterpassword && <span className='error-name-pass' id='error-name-renter'>{errors.Reenterpassword}</span>}<br/>
